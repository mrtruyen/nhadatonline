...
if ($page > 1)
	$pagination.= "<a href='".$path."page=$prev'><font  style=font-size:14px><< </font> previous</a>";
else
	$pagination.= "<span class='disabled'><font  style=font-size:14px><< </font> previous</span>";   
...
if ($page < $counter - 1)
	$pagination.= "<a href='".$path."page=$next'>next  <font  style=font-size:14px>>> </font></a>";
else
	$pagination.= "<span class='disabled'>next  <font  style=font-size:14px>>> </font> </span>";
	$pagination.= "</div>\n";       
}
return $pagination;
}
