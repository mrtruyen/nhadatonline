    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn btn-info" data-dismiss="modal" onclick="show_property_image('property_image_div','<?=isset($_REQUEST['id'])?$_REQUEST['id']:0?>','<?=$type_id?>')">Done</button>
            </div>
        </div>
    </div>
</div>
